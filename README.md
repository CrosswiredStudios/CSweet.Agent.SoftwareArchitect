...
First-party C-Sweet Software Architect agent, version `0.13.0`, built on .NET 10,
`CSweet.Agent.SDK` 3.19.0, Microsoft Agent Framework Harness 1.15.0, and manifest protocol v2.
